...
Arsenal, BVB for Dortmund, and so on.
    ...
    python -m bot.tools.sync_emoji            show what matches and what is missing
    python -m bot.tools.sync_emoji --write    update season.py in place
...
SEASON_FILE = os.path.join(ROOT, "bot", "domain", "season.py")
