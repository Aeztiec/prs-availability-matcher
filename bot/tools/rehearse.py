...
outcome, so this exits non-zero if the automation makes a wrong decision.
    ...
    python -m bot.tools.rehearse           full transcript
    python -m bot.tools.rehearse --quiet   just the verdict
"""
...
from bot.domain.orchestrator import Action, advance, dashboard
from bot.domain.scheduling import Pref, Source, Status
from bot.ui.selector import SelectorState, describe_choice
from bot.domain.weeks import from_iso, to_iso, uk_time
