...
from bot.domain.weeks import uk_local_to_utc
...
# BL, LL, SA, L1) and `python -m bot.tools.sync_emoji --write` picks them up.
...
# TEAM_CODES above, then run  python -m bot.tools.sync_emoji  to pick them up.
TEAM_EMOJI = {
    # Premier League
    ...
    "TOTTENHAM HOTSPUR": "<:TOT:1550249393741893632>",
    # Bundesliga
    ...
    "JUVENTUS": "<:JUV:1550249435529875486>",
