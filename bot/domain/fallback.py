...
from . import sheet as timings_sheet

from bot.domain.slots import build_slots, sheet_columns_for
...
class Timings:
    ...
    def __init__(self, competition_key=None, granularity=None):
        self.competition = timings_sheet.find_competition(competition_key)
        self.sheet = timings_sheet.build_sheet(timings_sheet.load_sheet(self.competition))
